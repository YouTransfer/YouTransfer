...
function Router(options) {
	if (options == null){
		this.fileServer = new nstatic.Server('./dist');
	}else if (typeof options === 'string' || options instanceof String){
		this.fileServer = new nstatic.Server(options);
	}else if (typeof options === 'number'){
		throw 'Invalid router options(number) provided';
	}else if (_.isEmpty(options)){
		this.fileServer = new nstatic.Server('./dist');
	}else if (typeof options == 'object'){ //input is object
		this.fileServer = options.fileServer;
	}else{
		throw new Error('Unknow router options provided');
	}	
}
